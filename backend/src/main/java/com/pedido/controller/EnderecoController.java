...
public class EnderecoController {
    ...
    @PutMapping("/{id}/principal/{usuarioId}")
    public ResponseEntity<Endereco> definirPrincipal(@PathVariable Long id, @PathVariable Long usuarioId) {
        Endereco endereco = service.definirPrincipal(id, usuarioId);
        return ResponseEntity.ok(endereco);
    }
}